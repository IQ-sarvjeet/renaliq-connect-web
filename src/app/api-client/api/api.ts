...
export const APIS = [AccountService, AdmissionService, CacheService, CareMemberService, ClinicalQualityMatrixService, DocumentService, ExportService, HccService, NotificationService, PBIReportService, PatientService, PaymentReportService, PracticeService, RoleService, UserService, UserRoleService];
