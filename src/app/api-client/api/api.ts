...
export const APIS = [AccountService, AdmissionService, CareMemberService, ClinicalQualityMatrixService, ExportService, NotificationService, PatientService, PracticeService, UserService];
