...
export const APIS = [AccountService, AdmissionService, CacheService, CareMemberService, ClinicalQualityMatrixService, DocumentService, ExportService, NotificationService, PatientService, PracticeService, RoleService, UserService, UserRoleService];
